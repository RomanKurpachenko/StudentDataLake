...
namespace StudentDataLake.Controllers
{
	...
	public class CheckPointController : ControllerBase
	{
		...
		public async Task<ActionResult<List<CheckPointController>>> GetAsync()
		{
			try
			{
		...
		public async Task<ActionResult<CheckPoint>> GetAsync(int id)
		{
			try
			{
				var checkPoint = await _checkPointService.GetAsync(id);
